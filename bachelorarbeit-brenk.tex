...
\UzLThesisSetup{
  ...
  % !!! Your action is needed here !!!
  % !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  Diese Bachelorarbeit wurde unter der Aufsicht des Institutes für Informationssysteme geschrieben.
  %
  ...
  %
  Abstract              = {
     write a thesis that does not only advance
 
    ready-to-use designs and 
    takes care of many small typographical chores.
  },
  Zusammenfassung       = {
    In dieser Arbeit wird die Topic Modeling Methode Latent Dirichlet Allocation untersucht, um die Klassifikation von Anfragen in der .... 
  },
  %
